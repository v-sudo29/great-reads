...
const CreateListModal = ({ handleListModalClose }: CreateListModalProps) => {
    ...
    if (index !== defaultColors.length - 1) {
      return (
        ...
        >
          ...
          />
          <label className="w-0" htmlFor={`listColor-${obj.color}`}></label>
        </div>
      )
    } else
      return (
        ...
        >
          ...
          {customColor && (
            <div className="absolute top-[2px] left-[2px] rounded-[2px] w-[28px] h-[28px] bg-white border-[3px] border-white pointer-events-none">
              <div
      ...
      <div className="relative mt-[6.5rem] flex flex-col w-full h-max max-w-[358px] gap-3 px-4 py-5 bg-white rounded-xl xl:max-w-[480px] xl:mt-auto xl:mb-auto xl:p-6 xl:gap-5">
        ...
        <form>
          <div className="relative flex flex-col gap-[6px]">
            <label className={formLabelStyles} htmlFor="listName">
              List Name
            </label>
            <input
          ...
          <div className="flex flex-col gap-3 mt-4 xl:mt-6">
            <label className={formLabelStyles} htmlFor="listColor">
              List Color
            </label>
