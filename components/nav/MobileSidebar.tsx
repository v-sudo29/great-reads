...
const MobileSidebar = ({
  ...
  return (
    <>
    <div className={sidebarStyles + ' ' + 'fixed z-50 w-full max-w-[366px] self-start h-screen bg-[#F9FBFC] border-r border-r-[#DFE7EB] transition-transform duration-200 ease-out'}>
