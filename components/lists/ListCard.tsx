...
const ListCard = ({
  ...
  return (
    <div className="flex gap-3 justify-between items-center p-3 rounded-md">
      <Link href={`/lists/${listName.replace(/ /g, '_')}`}>
        <div className="flex flex-col gap-5">
          <div className="flex w-full justify-between">
            <h1 className="font-medium w-full self-center text-2xl">
              {listName}
            </h1>
                ...
                listName !== 'Want to Read' && (
                  <>
                    ...
                    <button
                      ...
                      className={`delete_button ${listName}`}
                    >
                      Delete
                    </button>
                  </>
          ...
          <div className="flex gap-4">{booksJSX}</div>
        </div>
      </Link>
    </div>
  )
